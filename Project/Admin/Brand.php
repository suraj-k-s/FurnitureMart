                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" id="txt_brand" name="txt_brand">
                                                </div>
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="brand.php?id=<?php echo $data["brand_id"];?>" class="status_btn">Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
</td>                                            </tr>
                                            <?php                    
                                              }
