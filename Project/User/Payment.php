...
require 'phpMail/src/SMTP.php';
  ...
  if($mail->send())
  {
				...
				$a = "update tbl_booking set booking_status='1' where booking_id='".$_SESSION["bid"]."'";
				 $upQry1 = "update tbl_cart set cart_status='1' where booking_id='" .$_SESSION["bid"]. "'";
				if($Conn->query($a))
				{
					$Conn->query($upQry1);
					?>
...
<body>
<a href="MYCart.php">Back To Cart</a>
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				...
				<div class="input-box">
					<input class="name" type="text" name="txtnname" id="txtnname" placeholder="Nick Name" requried >
					<i class="fa fa-user icon" aria-hidden="true"></i>
				</div>
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				<div class="input-box">
					<h4>Date of Birth</h4>
					<input class="dob" type="text" data-mask="00" name="txtdate" id="txtdate" placeholder="DD" required>
					<input class="dob" type="text" data-mask="00" name="txtmonth" id="txtmonth" placeholder="MM"required>
					<input class="dob" type="text" data-mask="0000" name="txtyear" id="txtyear" placeholder="YYYY"required>
				</div>
				<div class="input-box">
					<h4>Gender</h4>
			...
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="tel" id="txtcardno" name="txtcardno"  data-mask="0000 0000 0000 0000" placeholder="Card Number" required>
			...
			<div class="input-group">
				...
				<div class="input-box">
					...
					<i class="fa fa-calendar icon" aria-hidden="true"required></i>
				</div>
			</div>
