...
<html>
    ...
    <?php
        ...
        if (isset($_POST["btn_checkout"])) {
                ...
                $selC = "select * from tbl_booking b inner join tbl_user u on u.user_id=b.user_id where u.user_id='" .$_SESSION["uid"]. "'and booking_status='0'";
                $rs = $Conn->query($selC);
                $row=$rs->fetch_assoc();
                 $_SESSION["bid"] = $row["booking_id"];
                
                $upQry1 = "update tbl_booking set booking_date=curdate(),booking_amount='".$amt."' where user_id='" .$_SESSION["uid"]. "'";
                ...
                if($Conn->query($upQry1))
                {
         		  	...
         		  	?>
                    <script>
					window.location="Payment.php?mail=<?php echo $row["user_email"] ?>";
					</script>
                    <?php
        ...
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            ...
            <div class="product">
                ...
                <div class="product-quantity">
                    <input alt="<?php echo $row["cart_id"] ?>" type="number" value="<?php echo $row["cart_quantity"] ?>" min="1" max="<?php echo $rowst["stock"] ?>"/>
                </div>
