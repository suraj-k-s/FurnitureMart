...
include("../Connection/Connection.php");
    ...
    if (isset($_GET["action"])) {
        ...
        $sqlQry = "SELECT * from tbl_product p inner join tbl_subcategory sc on sc.subcategory_id=p.subcategory_id inner join tbl_category c on c.category_id=sc.category_id  inner join tbl_shop k on k.shop_id=p.shop_id inner join tbl_brand b on b.brand_id=p.brand_id where product_price between '".$_GET["min"]."' and '".$_GET["max"]."' ";
